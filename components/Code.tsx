    ...
    <div>
      ...
      {showCode && (
        <div className='relative'>
          ...
          <button
            className='bg-gray-500 text-xs hover:bg-gray-600 text-white font-bold py-1 px-2 rounded 
              focus:outline-none focus:shadow-outline mb-2 absolute top-0 right-0 transform -translate-x-1 translate-y-1'
            type='submit'
            onClick={copyCode}
          >
            {copyText}
